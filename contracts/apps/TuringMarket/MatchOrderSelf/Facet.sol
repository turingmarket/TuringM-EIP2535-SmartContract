...
import {ROLE_MATCH_ORDER} from "../../../Constants.sol";
...
contract MatchOrderSelfFacet is IMatchOrderSelfFacet, MatchOrderSelfBase, AccessControlBase, Facet {
    function MatchOrderSelfFacet_init() external onlyInitializing {
        _setFunctionAccess(this.matchOrderSelf.selector, ROLE_MATCH_ORDER, true);
